define(["https://api.tiles.mapbox.com/mapbox-gl-js/v1.2.0/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v2.2.0/mapbox-gl-geocoder.min.js","https://api.tiles.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js","https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.0.9/mapbox-gl-draw.js", "https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.2.1.min.js", "https://code.jquery.com/ui/1.12.1/jquery-ui.min.js","text! https://cdn.jsdelivr.net/gh/Xdev9/Geospatial/Mapbox_12.css"], function(mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info) {
    ...
    BasicControl.prototype.initialize = function(oControlHost, fnDoneInitializing, oDataStore) {
        ...
        document.getElementById("v1517_ValueComboBox").addEventListener("change", myFunction);
    ...
    function myFunction() {
	 ...
	 var visibility = map.getLayoutProperty('Properties2', 'visibility');
        ...
        if (sessionStorage.getItem('visibility') === 'visible') {
			...
			//document.getElementById("v1517_ValueComboBox").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('Properties2', 'visibility', 'visible');
			sessionStorage.setItem('visibility','visible');
			//document.getElementById("v1517_ValueComboBox").style.backgroundColor = '#EFE013';
        }
	}
	
	document.getElementById("v1529_ValueComboBox").addEventListener("change", myFunction2);
    ...
    function myFunction2() {
	 ...
	 var visibility = map.getLayoutProperty('points', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v1529_ValueComboBox").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('points', 'visibility', 'visible');
			//document.getElementById("v1529_ValueComboBox").style.backgroundColor = '#EFE013';
        }
    //map.setLayoutProperty('points', 'visibility', 'visible');
	
	}
	
	document.getElementById("v1541_ValueComboBox").addEventListener("change", myFunction3);
    ...
    function myFunction3() {
	 ...
	 var visibility = map.getLayoutProperty('Radar-Today', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v1541_ValueComboBox").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('Radar-Today', 'visibility', 'visible');
			//document.getElementById("v1541_ValueComboBox").style.backgroundColor = '#EFE013';
        }
    	
	}
	document.getElementById("v1553_ValueComboBox").addEventListener("change", myFunction4);
    ...
    function myFunction4() {
	 ...
	 var visibility = map.getLayoutProperty('Lightning-Today', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v1553_ValueComboBox").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('Lightning-Today', 'visibility', 'visible');
			//document.getElementById("v1553_ValueComboBox").style.backgroundColor = '#EFE013';
        }
    	
	}
	
	document.getElementById("v1565_ValueComboBox").addEventListener("change", myFunction5);
    ...
    function myFunction5() {
	 ...
	 var visibility = map.getLayoutProperty('Hurricane-Today', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v1565_ValueComboBox").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('Hurricane-Today', 'visibility', 'visible');
			//document.getElementById("v1565_ValueComboBox").style.backgroundColor = '#EFE013';
        }
    	
	}
	
	document.getElementById("v1577_ValueComboBox").addEventListener("change", myFunction6);
    ...
    function myFunction6() {
	 ...
	 var visibility = map.getLayoutProperty('Hazardous Weather - Today', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v1577_MultiSelectList").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('Hazardous Weather - Today', 'visibility', 'visible');
			//document.getElementById("v1577_MultiSelectList").style.backgroundColor = '#EFE013';
        }
    	
	}
	
	document.getElementById("v1589_ValueComboBox").addEventListener("change", myFunction7);
    ...
    function myFunction7() {
	 ...
	 var visibility = map.getLayoutProperty('Earthquakes-last 30days', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v1589_ValueComboBox").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('Earthquakes-last 30days', 'visibility', 'visible');
			//document.getElementById("v1589_ValueComboBox").style.backgroundColor = '#EFE013';
        }
    	
	}
	
	document.getElementById("v1601_ValueComboBox").addEventListener("change", myFunction8);
    ...
    function myFunction8() {
	 ...
	 var visibility = map.getLayoutProperty('Earthquake - Historical', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v1601_ValueComboBox").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('Earthquake - Historical', 'visibility', 'visible');
			//document.getElementById("v1601_ValueComboBox").style.backgroundColor = '#EFE013';
        }
    	
	}
	
		document.getElementById("v1613_ValueComboBox").addEventListener("change", myFunction9);
    ...
    function myFunction9() {
	 ...
	 var visibility = map.getLayoutProperty('Tornados - Historical', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v1613_ValueComboBox").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('Tornados - Historical', 'visibility', 'visible');
			//document.getElementById("v1613_ValueComboBox").style.backgroundColor = '#EFE013';
        }
