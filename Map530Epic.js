...
answer.innerHTML = '<p><strong>' + 'Number of Employees:  ' + window.aggr.toLocaleString('en-US', { style: 'currency', currency: 'USD' }) + '</strong></p>';
} else {
answer.innerHTML = '';
if (e.type !== 'draw.delete') alert("Use the draw tools to draw a polygon!");
    ...
    BasicControl.prototype.setData = function(oControlHost, oDataStore) {
        ...
        for (var iRow = 0; iRow < iRowCount; iRow++) {
            ...
            feature['properties'] = { 'name': oDataStore.getCellValue(iRow, 0), 'total_paid3': oDataStore.getCellValue(iRow, 18), 'street': oDataStore.getCellValue(iRow, 15), 'city': oDataStore.getCellValue(iRow, 16)  }
...
.setHTML('<h3>' + 'Property: ' + Claim_N + '</h3>' + 'Street: ' +  feature.properties.street + '<br>' + 'City: '  + feature.properties.city + '<br>' + '</p>')
	.addTo(map);
});
