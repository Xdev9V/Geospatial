...
map.on('click', function(e) {
  ...
  var popup = new mapboxgl.Popup({ offset: [0, -15] })
    .setLngLat(feature.geometry.coordinates)
    .setHTML('<h3>' + feature.properties.Date + '</h3><p>' + 'Magnitude: ' + feature.properties.Date + '<br>' + 'Year: ' + feature.properties.Confirmed + ' Month: ' + feature.properties.Recovered + ' Day: ' + feature.properties.Deaths + '</p>')
    .setLngLat(feature.geometry.coordinates)
    .addTo(map);
