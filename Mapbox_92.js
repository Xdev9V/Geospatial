define(["https://api.tiles.mapbox.com/mapbox-gl-js/v1.2.0/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v2.2.0/mapbox-gl-geocoder.min.js","https://api.tiles.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js","https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.0.9/mapbox-gl-draw.js", "https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.2.1.min.js", "https://code.jquery.com/ui/1.12.1/jquery-ui.min.js"], function(mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2) {
    ...
    BasicControl.prototype.initialize = function(oControlHost, fnDoneInitializing, oDataStore) {
        ...
        jQuery("tbody").prepend("<link rel='stylesheet' href='https://cdn.jsdelivr.net/gh/Xdev9/Geospatial/Mapbox_8.css' rel='stylesheet' />");
		
		jQuery("div.mapboxgl-ctrl-top-right").prepend(<q> <div id='console'> <div class='session' id='sliderbar'> <h5> <font color="yellow">Historical - Year: <label id='active-Year'>2013</label></font>   <input id='slider' class='row' type='range' min='2013' max='2019' step='1' value='2013'  /></h5> </div> </q>)
...
.setHTML('<div id=' + 'console' + '>' +
   '<div class=' + '<q>' + 'session' + '</q>' + ' ' +  'id=' + '<q>' + 'sliderbar' + '</q>' + '>' +
  '<h5>' + '<font color=' +"yellow" + '>' + 'Historical - Year: ' + '<label id=' + 'active-Year' + '>' + '2013' + '</label>' + '</font>' +
  '<input id=' + 'slider' + 'class=' + 'row' +  'type=' + 'range' + 'min=' + '2013' +  'max=' + '2019' +  'step=' + '1' +  'value=' + '2013' + '/>' + '</h5>' +
'</div>' )
.addTo(map);
});
