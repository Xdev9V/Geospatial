...
if (e.type !== 'draw.delete') alert("Use the draw tools to draw a polygon!");
    ...
    BasicControl.prototype.setData = function(oControlHost, oDataStore) {
        ...
        for (var iRow = 0; iRow < iRowCount; iRow++) {
            ...
            feature['properties'] = { 'name': oDataStore.getCellValue(iRow, 0), 'total_paid3': oDataStore.getCellValue(iRow, 16), 'street': oDataStore.getCellValue(iRow, 15)  }
		...
		console.log('test2')
		map.on('click', 'points', function (e) tota
...
.setHTML('<h3>' + 'Property: ' + Claim_N + '</h3>' + 'Street: ' +  feature.properties.street + '<br>' + 'City: ' + feature.properties.Insured_Value + '</p>')
	.addTo(map);
});
