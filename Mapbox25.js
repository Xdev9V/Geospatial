define(["https://api.tiles.mapbox.com/mapbox-gl-js/v0.45.0/mapbox-gl.js","https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v2.2.0/mapbox-gl-geocoder.min.js","jquery"], function(mapboxgl, GEO, jQuery) {
    "use strict";
    var map = '',
        bounds = '',
        geojsonFeature = {};
