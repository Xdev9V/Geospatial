...
'https://nowcoast.noaa.gov/arcgis/services/nowcoast/radar_meteo_imagery_nexrad_time/MapServer/WmsServer?service=WMS&request=GetMap&version=1.3.0&layers=1&styles=&format=image/png&transparent=true&height=256&width=256&crs=EPSG:3857&bbox={bbox-epsg-3857}&time='+timeBlock
 ...
 // Change the cursor to a pointer when the mouse is over the places layer.
  ...
  // Change it back to a pointer when it leaves.
    ...
    map.addSource('IT_201811_FLRF_U_RP20_RB_5m_4-2460hd', {
        type: 'raster',
        url: 'mapbox://fxhawk.7sa94rse'
		
    });
	map.addLayer({
            "id": "Flood",
            "type": "raster",
            "source": "IT_201811_FLRF_U_RP20_RB_5m_4-2460hd",
            "source-layer": "IT_201811_FLRF_U_RP20_RB_5m_4-2460hd",
		    "tileSize": 256,
            "layout": {
                "visibility": 'visible'},
    ...
    map.addSource('FR_201802_FLRF_U_RP20_RB_5m_4-0gg3s5', {
        type: 'raster',
        url: 'mapbox://fxhawk.a7o0iig9'
		
    });
	map.addLayer({
            "id": "Flood",
            "type": "raster",
            "source": "FR_201802_FLRF_U_RP20_RB_5m_4-0gg3s5",
            "source-layer": "FR_201802_FLRF_U_RP20_RB_5m_4-0gg3s5",
		    "tileSize": 256,
            "layout": {
                "visibility": 'visible'},
    ...
    map.addSource('DE_201906_FLRF_U_RP20_RB_5m_4-6irzw7', {
        type: 'raster',
        url: 'mapbox://fxhawk.cj9m827h'
		
    });
	map.addLayer({
            "id": "Flood",
            "type": "raster",
            "source": "DE_201906_FLRF_U_RP20_RB_5m_4-6irzw7",
            "source-layer": "DE_201906_FLRF_U_RP20_RB_5m_4-6irzw7",
		    "tileSize": 256,
            "layout": {
                "visibility": 'visible'},
