...
// Corona*************************************************************************************
    ...
    map.addSource('cv_data_update', {
        type: 'vector',
        url: 'mapbox://fxhawk.ck7nh623f01632rpg7nig9pzk-08kyz'
    });
	map.addLayer({
        'id': 'corona_all',
         "type": "circle",
            "source": "cv_data_update",
            "source-layer": "cv_data_update",
            "layout": {
                "visibility": corona
            },
            "paint": {
...
// Corona*****************************************************************************************
		...
		map.on('load', function () {
    map.addSource('Locations_5', {
        type: 'vector',
        url: 'mapbox://fxhawk.ck7mc9pcn04672ro77ne0f9gn-68hz9'
    });
	map.addLayer({
        'id': 'Locations_5',
        'type': 'symbol',
        'source': 'Locations_5',
		'source-layer': 'Locations_5',
		 "layout": {
                "visibility": property,
                "text-field": [
                    "to-string",
