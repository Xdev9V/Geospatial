...
if (e.type !== 'draw.delete') alert("Use the draw tools to draw a polygon!");
    ...
    BasicControl.prototype.setData = function(oControlHost, oDataStore) {
        ...
        for (var iRow = 0; iRow < iRowCount; iRow++) {
            ...
            feature['properties'] = { 'name': oDataStore.getCellValue(iRow, 0), 'total_paid2': oDataStore.getCellValue(iRow, 14)  }
...
var description = e.features[0].properties.total_paid2;
...
.setHTML('<p><strong>' + 'Claim Number: ' + description + '</strong></p>' + '<br><strong>' + 'Total Paid: ' + coordinates + '</strong></p>' )
	.addTo(map);
});
