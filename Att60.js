...
// Change the cursor to a pointer when the mouse is over the places layer.
  ...
  var popup = new mapboxgl.Popup({ offset: [0, -15] })
    .setLngLat(feature.geometry.coordinates)
    .setHTML('<h3>' +'Claim Number: ' + feature.properties.Claim_Number + '</h3>'  + 'DOL: ' +  feature.properties.DOL + '<br>' + 'Status: ' + feature.properties.Status + 'Total Paid: ' + feature.properties.Total_Paid +   '</p>')
    .setLngLat(feature.geometry.coordinates)
