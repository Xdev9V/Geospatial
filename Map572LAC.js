...
if (e.type !== 'draw.delete') alert("Use the draw tools to draw a polygon!");
  ...
  var popup = new mapboxgl.Popup({ offset: [0, -15] })
    .setLngLat(feature.geometry.coordinates)
    .setHTML('<h3>' + feature.properties.name + '</h3>'  + 'Street: ' +  feature.properties.street + '<br>' + 'Prop: ' + feature.properties.total_paid3.toLocaleString('en-US', { style: 'currency', currency: 'USD' }) + '<br>' + 'Sqft:  ' + feature.properties.Sqft   + '<br>' + 'Number of Employees: ' + feature.properties.Num_of_Employees +  '</p>')
    .setLngLat(feature.geometry.coordinates)
