 ...
 map.on('load', function() {
     ...
     map.on('load', function() {
        map.addLayer({
            ...
            "source": {
                "type": "raster",
                "tiles": ['https://wildfire.cr.usgs.gov/arcgis/rest/services/geomac_fires/MapServer//export?dpi=96&transparent=true&format=png32&layers=show%3A0&bbox={bbox-epsg-3857}&bboxSR=EPSG:3857&imageSR=EPSG:3857&size=256,256&f=image'],
				        "tileSize": 256

            },  'layout': {'visibility': Wildfire},
        });
