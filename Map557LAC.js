...
if (e.type !== 'draw.delete') alert("Use the draw tools to draw a polygon!");
    ...
    BasicControl.prototype.setData = function(oControlHost, oDataStore) {
        ...
        for (var iRow = 0; iRow < iRowCount; iRow++) {
            ...
            feature['properties'] = { 'name': oDataStore.getCellValue(iRow, 0), 'total_paid3': oDataStore.getCellValue(iRow, 17), 'Number_Emp': oDataStore.getCellValue(iRow, 18), 'SQFT': oDataStore.getCellValue(iRow, 19), 'Street': oDataStore.getCellValue(iRow, 16) , 'Year': oDataStore.getCellValue(iRow, 15) }
