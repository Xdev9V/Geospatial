...
new mapboxgl.Popup()
    .setLngLat(feature.geometry.coordinates)
    .setHTML('<h3>' + feature.properties.name + '</h3>'  + 'Street: ' +  feature.properties.Street + '<br>' + 'Property Value: ' + feature.properties.Property_Value + '<br>' + 'Sqft:  ' + feature.properties.Sqft   + '<br>' + 'Number of Employees: ' + feature.properties.Num_of_Employees +  '</p>')
    .setLngLat(feature.geometry.coordinates)
