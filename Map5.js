    ...
    function myFunction2() {
	 ...
	 var visibility = map.getLayoutProperty('points', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v41_ValueComboBox").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('points', 'visibility', 'visible');
			//document.getElementById("v41_ValueComboBox").style.backgroundColor = '#EFE013';
        }
    //map.setLayoutProperty('points', 'visibility', 'visible');
	
	}
	
	document.getElementById("v53_ValueComboBox").addEventListener("change", myFunction3);
    ...
    function myFunction3() {
	 ...
	 var visibility = map.getLayoutProperty('Radar-Today', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v53_ValueComboBox").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('Radar-Today', 'visibility', 'visible');
			//document.getElementById("v53_ValueComboBox").style.backgroundColor = '#EFE013';
        }
    ...
    function myFunction4() {
	 ...
	 var visibility = map.getLayoutProperty('Lightning-Today', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v65_ValueComboBox").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('Lightning-Today', 'visibility', 'visible');
			//document.getElementById("v65_ValueComboBox").style.backgroundColor = '#EFE013';
        }
    	
	}
	
	document.getElementById("v77_ValueComboBox").addEventListener("change", myFunction5);
    ...
    function myFunction5() {
	 ...
	 var visibility = map.getLayoutProperty('Hurricane-Today', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v77_ValueComboBox").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('Hurricane-Today', 'visibility', 'visible');
			//document.getElementById("v77_ValueComboBox").style.backgroundColor = '#EFE013';
        }
    	
	}
	
	document.getElementById("v89_ValueComboBox").addEventListener("change", myFunction6);
    ...
    function myFunction6() {
	 ...
	 var visibility = map.getLayoutProperty('Hazardous Weather - Today', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v89_MultiSelectList").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('Hazardous Weather - Today', 'visibility', 'visible');
			//document.getElementById("v89_MultiSelectList").style.backgroundColor = '#EFE013';
        }
    	
	}
	
	document.getElementById("v101_MultiSelectList").addEventListener("change", myFunction7);
    ...
    function myFunction7() {
	 ...
	 var visibility = map.getLayoutProperty('Earthquakes-last 30days', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v101_MultiSelectList").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('Earthquakes-last 30days', 'visibility', 'visible');
			//document.getElementById("v101_MultiSelectList").style.backgroundColor = '#EFE013';
        }
    	
	}
	
	document.getElementById("v113_MultiSelectList").addEventListener("change", myFunction8);
    ...
    function myFunction8() {
	 ...
	 var visibility = map.getLayoutProperty('Earthquake - Historical', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v113_MultiSelectList").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('Earthquake - Historical', 'visibility', 'visible');
			//document.getElementById("v113_MultiSelectList").style.backgroundColor = '#EFE013';
        }
    	
	}
	
		document.getElementById("v125_MultiSelectList").addEventListener("change", myFunction9);
    ...
    function myFunction9() {
	 ...
	 var visibility = map.getLayoutProperty('Tornados - Historical', 'visibility');
        ...
        if (visibility === 'visible') {
			...
			//document.getElementById("v125_MultiSelectList").style.backgroundColor = '#9BA3A5';
            
        } else {
            
            map.setLayoutProperty('Tornados - Historical', 'visibility', 'visible');
			//document.getElementById("v125_MultiSelectList").style.backgroundColor = '#EFE013';
        }
