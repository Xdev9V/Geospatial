...
// Corona*************************************************************************************
 ...
 "stops": [
 [{zoom: 0, value: 1}, 2],
 [{zoom: 0, value: 5000}, 15],
 [{zoom: 11, value: 1}, 20],
 [{zoom: 11, value: 5000}, 900],
 [{zoom: 20, value: 1}, 40],
 [{zoom: 20, value: 5000}, 2250]
 ],
...
map.on('click', function(e) {
  ...
  var popup = new mapboxgl.Popup({ offset: [0, -15] })
    .setLngLat(feature.geometry.coordinates)
    .setHTML('<h3>' + feature.properties.Region + '   ' +  feature.properties.State + '</h3><p>' + 'Date: ' + feature.properties.Date + '<br>' + 'Confirmed: ' + feature.properties.Confirmed + ' Recovered: ' + feature.properties.Recovered + ' Deaths: ' + feature.properties.Deaths + '</p>')
    .setLngLat(feature.geometry.coordinates)
    .addTo(map);
