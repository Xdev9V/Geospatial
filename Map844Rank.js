...
// Corona*****************************************************************************************
  ...
  var popup = new mapboxgl.Popup({ offset: [0, -15] })
    .setLngLat(feature.geometry.coordinates)
    .setHTML('<h3>' + feature.properties.Office + '</h3>'  + 'Street: ' +  feature.properties.Street + '<br>' + 'Property Value: ' + feature.properties.Property_Value + '<br>' + 'TIV:  ' + feature.properties.Sqft   + '<br>' + 'Number of Employees: ' + feature.properties.Num_of_Employees +  '</p>')
    .setLngLat(feature.geometry.coordinates)
 ...
 map.on('draw.create', function (e){
      ...
      window.aggr = features.reduce(function (memo,feature, Paid3) {
            ...
            if (! (undefined === turf.intersect(feature, userPolygon))) {
              ...
              var Paid3 = feature.properties.TIV;
...
answer.innerHTML = '<p><strong>' + 'TIV: ' + window.aggr.toLocaleString() + '</strong></p>';
} else {
answer.innerHTML = '';
if (e.type !== 'draw.delete') alert("Use the draw tools to draw a polygon!");
    ...
    BasicControl.prototype.setData = function(oControlHost, oDataStore) {
        ...
        for (var iRow = 0; iRow < iRowCount; iRow++) {
            ...
            feature['properties'] = { 'name': oDataStore.getCellValue(iRow, 0), 'Asset_Band': oDataStore.getCellValue(iRow, 17), 'street': oDataStore.getCellValue(iRow, 16), 'TIV': oDataStore.getCellValue(iRow, 19),  'Prop_ID': oDataStore.getCellValue(iRow, 18)  }
...
map.on('click', function(e) {
  ...
  var popup = new mapboxgl.Popup({ offset: [0, -15] })
    .setLngLat(feature.geometry.coordinates)
    .setHTML('<h3>' + feature.properties.name + '</h3>'  + 'Street: ' +  feature.properties.street + '<br>' + 'Asset Band: ' + feature.properties.Asset_Band + '<br>' + 'TIV:  ' + feature.properties.TIV   + '<br>' + 'Prop_ID: ' + feature.properties.Prop_ID +  '</p>')
    .setLngLat(feature.geometry.coordinates)
