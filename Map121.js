...
// Change the cursor to a pointer when the mouse is over the places layer.
 ...
 map.on('draw.create', function (e){
      ...
      window.aggr = features.reduce(function (memo, feature.properties.total_paid3) {
            ...
            if (! (undefined === turf.intersect(feature, userPolygon))) {
			 ...
			 var Paid3 = parseFloat(feature.properties.total_paid3);
			 ...
			 console.log(features)
                ...
                console.log(memo)
                return parseFloat(memo) + Paid3  ;
        }, 0);
		console.log(aggr)
    var answer = document.getElementById('calculated-area');
       // answer.innerHTML = '<p><strong>' + aggr + '</strong></p><p>'square meters'</p>';
