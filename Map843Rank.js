...
map.on('click', function(e) {
  ...
  var popup = new mapboxgl.Popup({ offset: [0, -15] })
    .setLngLat(feature.geometry.coordinates)
    .setHTML('<h3>' + feature.properties.name + '</h3>'  + 'Street: ' +  feature.properties.street + '<br>' + 'Asset Band: ' + feature.properties.Asset_Band + '<br>' + 'Sqft:  ' + feature.properties.TIV   + '<br>' + 'Prop_ID: ' + feature.properties.Prop_ID +  '</p>')
    .setLngLat(feature.geometry.coordinates)
